    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType){
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                title.setTextColor(Color.parseColor("#90000000"));
                LinearLayout.LayoutParams layoutParams=new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,LinearLayout.LayoutParams.WRAP_CONTENT);
                layoutParams.setMargins(setDp(0,viewGroup.getContext()),setDp(8,viewGroup.getContext()),setDp(0,viewGroup.getContext()),setDp(8,viewGroup.getContext()));
